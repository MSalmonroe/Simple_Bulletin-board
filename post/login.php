  ...
  <div id="head">
    ...
    <div id="content">
        ...
        <form action="" method="POST">
            <dl>
                <dt>メールアドレス</dt>
                <dd><input type="text" name="email" size="35" maxlength="255" value="<?php if(!empty($_POST['email'])) echo htmlspecialchars($_POST['email'],ENT_QUOTES); ?>">
                ...
                <dt>パスワード</dt>
                <dd><input type="password" name="password" size="35" maxlength="255" value="<?php if(!empty($_POST['password'])) echo htmlspecialchars($_POST['password'],ENT_QUOTES); ?>"></dd>
                <dt>ログイン情報の記録</dt>
